...
- Y-up: agg-gui is Y-up first-quadrant; the JS reference is Y-down. The flip happens once in `antidote_core::render::scene::flip_y` — do not flip again at lower levels.
